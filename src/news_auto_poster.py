...
TOPIC_CONFIG = {
    "F1_모터스포츠": {
        ...
        "tag_ids": [20], # 예: f1-motorsports 태그 ID (숫자로 입력)
    ...
    "IT트렌드": {
        ...
        "tag_ids": [25, 27], # it-tech-trends 태그 ID
    ...
    "글로벌_스포츠": {
        ...
        "tag_ids": [46, 45, 28, 44], # 예: #해외스포츠, #경기결과 태그 번호
    ...
    "국내_스포츠": {
        ...
        "tag_ids": [39, 45, 28], # 예: #프로야구, #K리그 태그 번호
