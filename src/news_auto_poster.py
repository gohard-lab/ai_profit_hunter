...
TOPIC_CONFIG = {
    "F1_모터스포츠": {
        ...
        "cat_id": 14,
        "tag_ids": [20],
        "default_media_id": 1082,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "올드무비": {
        ...
        "cat_id": 15,
        "tag_ids": [22, 23],
        "default_media_id": 1083,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "레트로기기": {
        ...
        "cat_id": 17,
        "tag_ids": [36, 37],
        "default_media_id": 1096,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "IT트렌드": {
        ...
        "cat_id": 7,
        "tag_ids": [25, 27],
        "default_media_id": 1089,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "글로벌_스포츠": {
        ...
        "cat_id": 29,
        "tag_ids": [46, 45, 28, 44],
        "default_media_id": 1091,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "해외_엔터이슈": {
        ...
        "cat_id": 34,
        "tag_ids": [38],
        "default_media_id": 1086,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "국내_연예": {
        ...
        "cat_id": 35,
        "tag_ids": [42, 40],
        "default_media_id": 1099,  # 👈 여기에 F1 이미지 ID 입력
    ...
    "국내이슈": {
        ...
        "cat_id": 68,  # 워드프레스 내 관련 카테고리 ID
        "tag_ids": [70, 71, 72, 73, 74],  # 관련 태그 ID
        "default_media_id": 1097,  # 👈 여기에 F1 이미지 ID 입력
        "prompt": "세상 돌아가는 실무적인 이치를 탐구하는 잡학다식 개발자로서, 이번 소식이 일반 시민들의 지갑이나 생활에 어떤 직접적인 변화를 주는지 지적이고 솔직 담백하게 분석해 줘. 탁상공론식 설명보다는 실제 체감될 부분을 짚어주는 것이 핵심이야."
    }
